  ...
  if (anonimo.innerHTML === "Anonimo") {
    ...
    potwiedzenieJS.addEventListener("click", () => {
      ...
      if (anonimoSelected2 === "Złoto") {
        ...
        const apiIndeksy = `http://www.moje-inwestycje.pl/api/akcje/`;
        fetch(apiIndeksy)
          .then((response) => {
            return response.json();
          })
        ...
        const apiIndeksy = `http://www.moje-inwestycje.pl/api/indeksy/`;
        fetch(apiIndeksy)
          .then((response) => {
            return response.json();
          })
        ...
        const apiIndeksy = `http://www.moje-inwestycje.pl/api/newconnect/`;
        fetch(apiIndeksy)
          .then((response) => {
            return response.json();
          })
